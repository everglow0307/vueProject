...
export default new Vuex.Store({
  ...
  getters: {
    ...
    searchedDiary : (state, keyword) => state.diaryList.filter(diary => diary.user.match(state.currentUser)&&diary.title.includes(keyword)),
  },
  mutations: {
    ...
    writeOne : (state, diary) => {state.diaryList.push(diary)},
